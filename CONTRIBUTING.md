...
Filters involve changes across multiple files. Follow the step-by-step guide in
[docs/EXTENDING_FILTERS.md](docs/EXTENDING_FILTERS.md) to avoid silent failures or
runtime crashes.
