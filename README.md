...
For a detailed walkthrough of how the addon works internally — data flow between components, caching, retry behavior, and key design decisions — see **[docs/ARCHITECTURE.md](docs/ARCHITECTURE.md)**.
